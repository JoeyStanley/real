...
[*Intro to R (Part 1)*](/downloads/180119-intro-to-r-part1): In this workshop I cover the basics of R itself. I talk about the differences between R and RStudio and I helped folks get both installed and running on their computers. We created a simple "Hello, World!" script using R. 
...
[*Intro to R (Part 2)*](/downloads/180126-intro-to-r-part2): Now that R is ready to go, this workshop will cover the basics of the R language. It will also be a very simple introduction to some core computer coding concepts like declaring variables and variable types. 
...
[*Visualization I: Introduction to ggplot2*](/downloads/180216-ggplot2-part1): ggplot2 is a widely used package that allows for high-quality visualizations. In this workshop I cover the basic syntax and how to make some simple types of plots.
...
[*Visualization II: Customizing plots in ggplot2*](/downloads/180223-ggplot2-part2): The basic plots in ggplot2 are good, but often you'll want to customize them in some way. In this workshop we'll cover how to mess with properties of the plots like the axes, colors, and legends to make the plot work better for you.
...
[*Clean and tidy data: The tidyverse (part 1)*](/downloads/180302-tidyverse_part1.html): The tidyverse is a suite of packages that helps you wrangle your data. In this two-part workshop, we'll learn some of the common functions in the tidyverse and compare them to base R, showing that there are multiple ways to accomplish the same task in R.
...
[*Reshaping and transforming your data: The tidyverse Part 2*](/downloads/180323-tidyverse_II.html): This workshop extends what was covered in Part 1. In particular, we'll look at how to reshape and transform your data, merging it with other dataset, and other super useful and powerful tools.
...
[*Communicate with your audience: An intro to RMarkdown*](/downloads/180309-rmarkdown.html): R Markdown is a way to create different types of documents using R (pdfs, word files, html files). In this one-day crash course, I'll show how to make R Markdown files and the kinds of things they would be useful for.
...
*Building interactive webpages in R: Introduction to Shiny*: Shiny is an R package that allows you to make your own interactive web pages. An entire semester could be devoted to shiny, so these two days will cover just the essentials.
...
[*In Introduction to R*](/downloads/170913-intro_to_R.html): In this workshop I go over the basics of R including installation, basic functions, loading your data into R, filtering, visualizations, and where to find help. 
...
[`ggplot2`](/downloads/171012-ggplot2.html): Here I discuss the popular `ggplot2` package, a collection of functions that makes it easy to create stunning, professional-quality visualizations. Specifically, I cover basic plots, how to modify them, and some of my thoughts on data visualization.
...
[`tidyverse`](/downloads/171110-tidyverse.html): This workshop discusses a collection of R packages known as the `tidyverse`. This includes packages like `dplyr`, `tidyr`, `stringr`, and `ggplot2`. They are designed with the same underlying mechanisms so they they work harmoneously together to make it easy to import, tidy, and reshape your data for future analysis.
